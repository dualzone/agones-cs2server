...
RUN useradd -m cs2user && \
    ...
    chmod -R 770 /home/cs2user/cs2_server /root/Steam
...
RUN curl -sSL http://media.steampowered.com/installer/steamcmd_linux.tar.gz | tar -xz && \
    chown -R cs2user:cs2user /home/cs2user/steamcmd.sh && \
    chmod +x /home/cs2user/steamcmd.sh && \
    chmod -R +x /home/cs2user/linux32/steamcmd
